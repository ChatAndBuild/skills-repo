...
id: gget
name: gget
description: Guidance and answers for gget, a tool for fetching genomic information and mapping identifiers from various databases.
category: Research
requires: []
examples:
  - How do I use gget to fetch genomic information from Ensembl?
  - Use gget to search for human protein sequences in NCBI.
---
